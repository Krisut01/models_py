...
Complete all the tasks from the Final Project: Add a New Assessment Feature to an Online Course App.
For each task, make sure to save the URLs of the files and the required screenshots, and store them using the corresponding filenames.
Select 'Begin the Assignment' to get started.
Read each question and submit your response by providing URLs or screenshots taken for the project.
...
Grading Criteria
You are required to upload GitHub repository URLs and screenshots showing your project implementation. The AI evaluator will provide feedback on your submission. The final project is worth 15 points, and you are required to score at least 70% to pass.
